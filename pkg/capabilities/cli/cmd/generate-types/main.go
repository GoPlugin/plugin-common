...
import (
	...
	"github.com/goplugin/plugin-common/pkg/capabilities/cli/cmd"
)
...
var localPrefix = flag.String("local_prefix", "github.com/goplugin", "The local prefix to use when formatting go files")
